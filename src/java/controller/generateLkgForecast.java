 ...
 */
public class generateLkgForecast extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Double area=null,rain=null,tiller=null,temp=null,production=null,lkg=null;
            String area1=null,rain1=null,tiller1=null,temp1=null,production1=null,lkg1=null;
        ...
        boolean check =  cedb.selectLkgEstimates(area,production,lkg, rain);
            if (check){
                ...
                ServletContext context = getServletContext();
                 response.sendRedirect("viewCropEstimateBoard");
            }
            else {
                ServletContext context = getServletContext();
