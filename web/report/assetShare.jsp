                        ...
                        <div class="col-md-12">
                            <div class="content-panel">
                                ...
                                <div class="row" style="border: 1px solid black; margin: 5px 30px">
                                    <form action="/AMS/ReportServlet/GenerateAssetShares">
                                        ...
                                        <div class="col-md-8" style="margin: 20px auto; text-align: center">
                                            ...
                                            <button class="btn" type="submit" onclick="alert('Asset Share Report Generated!')">Generate Report</button>
                                        </div>
                                    </form>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <button onclick="document.getElementById('pdfViewer').setAttribute('data', '/AMS/pdf/assetShare/<%=file%>')"><%=file%></button>
                                                    </td>
                                                </tr>
                                                <%
                                                    }
