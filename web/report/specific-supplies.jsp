<%-- 
    Document   : specific-supplies
    Created on : 11 24, 18, 5:21:30 PM
    Author     : rubysenpaii
--%>
                                    ...
                                    <div class="col-md-4">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <button onclick="document.getElementById('pdfViewer').setAttribute('data', '/AMS/pdf/specific-supplies/<%=file%>')"><%=file%></button>
                                                    </td>
                                                </tr>
                                                <%
                                                    }
