...
<header class="main-header">
    ...
    <aside class="main-sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="active"><a href="Homepage_Board.jsp"><i class="fa fa-dashboard"></i><span>Dashboard</span></a></li>
            <li class="treeview">
                <a href="MDOHomepage">
                    <i class="fa fa-share"></i> <span>Tarlac</span>
                    <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu" style="display: none;">
                     <li><a href="MDOHomepage"> <i class="fa fa-arrow-right"></i><span>District Performance</span></a></li>
                    <li><a href="Problems.jsp"><i class="fa fa-exclamation-triangle"></i><span>Problems (Reoccuring)</span></a></li>
                    <li><a href="Calendar.jsp"><i class="fa fa-calendar"></i><span>Calendar</span> </a></li>
                    <li><a href="viewCropEstimateBoard"><i class="fa fa-bar-chart"></i><span>Crop Estimate (Board)</span></a></li>
                    <li><a href="viewPrograms.jsp"><i class="fa fa-eye"></i><span>View Programs</span></a></li>
                    <li><a href="createProject.jsp"><i class="fa fa-plus"></i><span>Create Plans and Programs</span></a></li>
